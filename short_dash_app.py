...
ratings = pd.read_csv('https://github.com/kelleyxiao/Stat542-Project4/blob/main/ratings.dat', sep='::', engine = 'python', header=None)
ratings.columns = ['UserID', 'MovieID', 'Rating', 'Timestamp']
movies = pd.read_csv('https://github.com/kelleyxiao/Stat542-Project4/blob/main/movies.dat', sep='::', engine = 'python', encoding="ISO-8859-1", header = None)
...
# System II
ratings_df = pd.read_csv('https://github.com/kelleyxiao/Stat542-Project4/blob/main/ratings_df.csv')

pruned_similarity_matrix = np.load('https://github.com/kelleyxiao/Stat542-Project4/blob/main/pruned_similarity_matrix_short.npy')
